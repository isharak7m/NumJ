...
public final class Arrays {
    ...
    public static NDArray squeeze(NDArray a, int... axes) {
    ...
    public static NDArray round(NDArray a) {
        return UFunc.round(a);
    }
    ...
    public static NDArray randint(int low, int high, int... shape) {
        return Random.randint(low, high, shape);
    }
    ...
    public static NDArray ascontiguousarray(NDArray a) {
        return Util.asContiguous(a);
    }
