...
final class HeapMemoryBuffer {
    ...
    record ByteBuffer(byte[] data) implements MemoryBuffer {
        ...
        public MemoryBuffer duplicate() {
            return new ByteBuffer(data.clone());
        }
        ...
        public char getChar(long index) {
            return (char) data[(int) index];
        }

        @Override
        public String getString(long index) {
            return String.valueOf(data[(int) index]);
        }
        ...
        public void setString(long index, String value) {
            data[(int) index] = Byte.parseByte(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Byte b ? b : 0;
        }
    ...
    record ShortBuffer(short[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new ShortBuffer(data.clone());
        }
        ...
        @Override
        public void setBool(long index, boolean value) {
            data[(int) index] = (short) (value ? 1 : 0);
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = Short.parseShort(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Short s ? s : 0;
        }
    ...
    record IntBuffer(int[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new IntBuffer(data.clone());
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = Integer.parseInt(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Integer i ? i : 0;
        }
    ...
    record LongBuffer(long[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new LongBuffer(data.clone());
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = Long.parseLong(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Long l ? l : 0L;
        }
    ...
    record FloatBuffer(float[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new FloatBuffer(data.clone());
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = Float.parseFloat(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Float f ? f : 0f;
        }
    ...
    record DoubleBuffer(double[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new DoubleBuffer(data.clone());
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = Double.parseDouble(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Double d ? d : 0.0;
        }
    ...
    record BoolBuffer(boolean[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new BoolBuffer(data.clone());
        }
        ...
        @Override
        public byte getByte(long index) {
            return (byte) (data[(int) index] ? 1 : 0);
        }

        @Override
        public short getShort(long index) {
            return (short) (data[(int) index] ? 1 : 0);
        }
        ...
        @Override
        public long getLong(long index) {
            return data[(int) index] ? 1L : 0L;
        }

        @Override
        public float getFloat(long index) {
            return data[(int) index] ? 1f : 0f;
        }

        @Override
        public double getDouble(long index) {
            return data[(int) index] ? 1.0 : 0.0;
        }
        ...
        @Override
        public char getChar(long index) {
            return data[(int) index] ? (char) 1 : (char) 0;
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = Boolean.parseBoolean(value);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Boolean b && b;
        }
    ...
    record CharBuffer(char[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new CharBuffer(data.clone());
        }
        ...
        @Override
        public void setBool(long index, boolean value) {
            data[(int) index] = value ? (char) 1 : (char) 0;
        }
        ...
        @Override
        public void setString(long index, String value) {
            data[(int) index] = value.isEmpty() ? '\u0000' : value.charAt(0);
        }

        @Override
        public void setObject(long index, Object value) {
            data[(int) index] = value instanceof Character c ? c : '\u0000';
        }
    ...
    record ObjectBuffer(Object[] data) implements MemoryBuffer {
        ...
        @Override
        public MemoryBuffer duplicate() {
            return new ObjectBuffer(data.clone());
        }
        ...
        @Override
        public byte getByte(long index) {
            return data[(int) index] instanceof Number n ? n.byteValue() : 0;
        }

        @Override
        public short getShort(long index) {
            return data[(int) index] instanceof Number n ? n.shortValue() : 0;
        }

        @Override
        public int getInt(long index) {
            return data[(int) index] instanceof Number n ? n.intValue() : 0;
        }

        @Override
        public long getLong(long index) {
            return data[(int) index] instanceof Number n ? n.longValue() : 0L;
        }

        @Override
        public float getFloat(long index) {
            return data[(int) index] instanceof Number n ? n.floatValue() : 0f;
        }

        @Override
        public double getDouble(long index) {
            return data[(int) index] instanceof Number n ? n.doubleValue() : 0.0;
        }

        @Override
        public boolean getBool(long index) {
            return Boolean.TRUE.equals(data[(int) index]);
        }

        @Override
        public char getChar(long index) {
            return data[(int) index] instanceof Character c ? c : '\u0000';
        }
